...
| `npm run license:check` | SPDX marking of every file the package ships; **CI runs the file directly** (`bootstrap/flang io scripts/storozh-licenzii.flang`), not through npm |
