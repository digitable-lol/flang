...
|                            | `тотальная`                 | обычная                       |
|----------------------------|-----------------------------|-------------------------------|
| рекурсия                   | убывающая: по части значения или по числовой мере | любая       |
...
- Анализ тотальности знает структурное убывание и числовую меру с ПОСТОЯННЫМ шагом. Всё, где шаг
  ...
  остаток, счёт вверх растёт — им по-прежнему нужен список-«топливо». Отдельная граница у самой
  меры: числа flang — IEEE-754 double, и при |x| ≥ 2⁵⁴ `x минус 1` равен x, так что доказательство
  меры верно на числах обычной величины, а не на всех double.
