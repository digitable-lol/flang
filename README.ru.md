...
[`digitable-lol/asdf-flang`](https://github.com/digitable-lol/asdf-flang). Оба ставят релизный
...
`new`, `repl` и `lsp`. Печатает он в 9 целевых языков.
...
Внутри `flang/`: [`flang/self/`](flang/self) — компилятор, 61 файл на flang —
