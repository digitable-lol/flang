...
#     sh benchmarks/bez-libc/zamer.sh
...
cc $OBSHCHIE -c -o chistoe.o chistoe.c
...
cc -std=gnu99 -O2 -DTOLKO_VHOD -fno-stack-protector -c -o tolko-vhod.o sloy.c
...
cc -std=gnu99 -O2 -Wall -Wextra -ffunction-sections -fdata-sections \
   -fno-stack-protector -fno-builtin -c -o sloy.o sloy.c
cc -std=c99 -O2 -nostdlib -static -Wl,--gc-sections -o bezlibc sloy.o chistoe.o rt.o modul.o
echo "слой: $(sed 's://.*::' sloy.c | perl -0777 -pe 's{/\*.*?\*/}{}gs' | grep -cvE '^[[:space:]]*$') строк кода"
...
cc $OBSHCHIE -c -o spisok.o spisok.c
