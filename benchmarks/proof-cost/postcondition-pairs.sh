...
#
#   benchmarks/proof-cost/postcondition-pairs.sh A.flang B.flang 3 test
#   benchmarks/proof-cost/postcondition-pairs.sh A.flang B.flang 3 test --no-check
#   benchmarks/proof-cost/postcondition-pairs.sh A.flang B.flang 3 check
#
