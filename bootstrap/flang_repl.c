...
static int emit_file(int argc, char **argv, const char *self) {
  ...
  if (code == 0) {
...

    {
       ...
       * ядра. Улика, снятая прогоном 20 августа 2026 по всем 824 программам
       * дерева: свидетель на Node отказывался печатать 447 из них, а двоичный
       * печатал 419 из этих 447 — кодом 0 и шестью файлами C. Двоичный,
       * печатающий то, что свидетель отвергает, опаснее двоичного, который
