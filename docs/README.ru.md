...
(`scripts/guards/link-guard.fscript`), а внутреннее слово на странице для читателя со стороны получает
отказ (`flang/scripts/jargon-guard.fscript`). Эта страница — одна из тех, что эти проверки читают.
