...
доля выше порога 95 %; набор проб пройден целиком — 453 пробы на подлог отвергнуты, 215 честных
записей приняты; набор проб не ослаб против своего храповика. Правила вывода, которыми пользуется
