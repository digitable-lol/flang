...
ещё 185 программ в остальных наборах — отдельные файлы, среди них набор LeetCode: 82 решения с
806 примерами.
...
`scripts/otpechatok-semeni`, по хешированной строке на файл — 65 строк.
