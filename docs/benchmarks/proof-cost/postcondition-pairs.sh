...
#
#   docs/benchmarks/proof-cost/postcondition-pairs.sh A.flang B.flang 3 test
#   docs/benchmarks/proof-cost/postcondition-pairs.sh A.flang B.flang 3 test --no-check
#   docs/benchmarks/proof-cost/postcondition-pairs.sh A.flang B.flang 3 check
#
