...
<!-- СНЯТО 2026-09-12 список flang/self/parser.flang:6615 = 22 --><!-- СНЯТО 2026-09-12 список flang/self/parser.flang:6624 = 20 --><!-- СНЯТО 2026-09-12 список flang/self/parser.flang:6633 = 4 -->
...
**Сверка списка целей с поведением — `scripts/targets/plan-across-targets.flang`.** Различает
...
```
bootstrap/flang io scripts/targets/plan-across-targets.flang
...
таблица «цель → исход» объявлена данными в `scripts/targets/plan-across-targets.flang` и
