...
<!-- СНЯТО 2026-09-17 файлов flang/self/*.flang = 68 --> 68 файлов `.flang`,
<!-- СНЯТО 2026-09-26 строк-в flang/self/*.flang = 139870 --> 139 870 строк
...
| `zapis.flang` | «Запись доказательства» | запись доказательства для независимого чекера (`docs/flang/proof/checker/README.md`) |
