...
<!-- СНЯТО 2026-09-14 строк-в flang/self/*.flang = 138903 --> 138 903 строк
...
| `zapis.flang` | «Запись доказательства» | запись доказательства для независимого чекера (`docs/flang/proof/чекер/ЧИТАТЬ.md`) |
...
Форма AST задана в `docs/flang/SPEC.md`, раздел 5, и другой нет. Печатает её
