...
Пока реализация на JavaScript ещё лежала в дереве, она печатала ту же точку, и
прогон 20 августа 2026 показал: обе печати совпали байт в байт — 7 файлов,
15 641 371 байт. Число снято нарочно, в последний день, когда было с чем
сверять: JavaScript удалён, и повторить сверку уже нельзя.
