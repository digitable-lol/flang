...
net_sredstva 'неподвижная точка самораскрутки' \
  ...
  'sh scripts/raskrutka.sh --check — сверяет закоммиченное семя с печатью побайтово; идёт часы, а не минуты (последний дошедший заход печати 30 августа 2026: 8 ч 34 мин 02 с на одном ядре; пик 24,3-35,4 ГиБ по трём заходам 31 августа)'
itog
