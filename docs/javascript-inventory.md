...
ОСЛАБЛЕННОЕ, `13-even` СОДЕРЖАТЕЛЬНОЕ. **Разошедшихся вердиктов больше нет:
20 из 20.** Это и снимает оговорку про сверку: теперь «сошлось знак в знак»
снова годный признак, потому что чинили не двойника под старое поведение, а
старое поведение.
