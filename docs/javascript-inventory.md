...
строк **29 715**. На 15 сентября 2026, после снятия напечатанного задачей 1423: 51.
На 26 сентября 2026, после снятия `proof-ledger.mjs` и `word-guard.mjs`
(задача 4413): **49**, строк **23 010**. <!-- СНЯТО 2026-09-26 файлов *.js,*.mjs = 49 (задача 4413: flang/scripts/proof-ledger.mjs и word-guard.mjs сняты — свод корпуса считает двойник на flang; до них 51 файл и 24 386 строк, снято 2026-09-17) -->
...
считает [`tree-inventory.md`](tree-inventory.md) (26 сентября 2026: 249 файлов вне flang,
...
23 010 строк этой описи — нижняя оценка.
<!-- СНЯТО 2026-09-26 строк-в *.js,*.mjs = 23010 (задача 4413: flang/scripts/proof-ledger.mjs и word-guard.mjs сняты — свод корпуса считает двойник на flang; до них 51 файл и 24 386 строк, снято 2026-09-17) (задача 1416: четырнадцать объявлений ярлыков заведены в скриптах и зов «Сбора» — в хуке; до них 24382, снято 2026-09-17) -->
...
**Напечатано компилятором — 8 файлов, 5 941 строка.** Проверено грепом 15 сентября 2026, после сноса части таких файлов задачей 1423:
...
| `scripts/site/build-changelog.mjs` | 878 | журнал |
| `scripts/site/build-changelog-page.mjs` | 833 | журнал |
...
Из той же справки: код возврата у «Провала» один на все причины. Экран из этого
списка ушёл 19 сентября 2026 — двоичный пишет кадр в управляющий терминал
(`/dev/tty`), а `FLANG_IO_NO_SCREEN` остался ответом там, где терминала нет.
