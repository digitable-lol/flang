...
[`tree-inventory.md`](tree-inventory.md) (1 сентября 2026: 236 файлов вне flang,
<!-- СНЯТО 2026-09-02 файлов *.sh,*.c,*.h,*.py,*.html,*.css,*.awk,*.erl,*.js,*.mjs,*.java,*.cs,*.ex,*.exs,*.go,*.rs,*.lua,*.vim,*.rb = 236 -->
