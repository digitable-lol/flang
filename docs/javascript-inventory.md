...
На 11 сентября (`2c40752d0`): `git ls-files '*.mjs' '*.js' | wc -l` → **52**,
строк **28 335**. <!-- СНЯТО 2026-09-11 файлов *.js,*.mjs = 52 -->
...
28 323 строк этой описи — нижняя оценка.
<!-- СНЯТО 2026-09-11 строк-в *.js,*.mjs = 28335 -->
