...
[`tree-inventory.md`](tree-inventory.md) (5 сентября 2026: 265 файлов вне flang,
<!-- СНЯТО 2026-09-05 файлов *.sh,*.c,*.h,*.py,*.html,*.css,*.awk,*.erl,*.js,*.mjs,*.java,*.cs,*.ex,*.exs,*.go,*.rs,*.lua,*.vim,*.rb = 265 -->
