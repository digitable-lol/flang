...
[`tree-inventory.md`](tree-inventory.md) (4 сентября 2026: 255 файлов вне flang,
<!-- СНЯТО 2026-09-04 файлов *.sh,*.c,*.h,*.py,*.html,*.css,*.awk,*.erl,*.js,*.mjs,*.java,*.cs,*.ex,*.exs,*.go,*.rs,*.lua,*.vim,*.rb = 255 -->
...
28 292 строки этой описи — нижняя оценка.
<!-- СНЯТО 2026-09-04 строк-в *.js,*.mjs = 28292 -->
