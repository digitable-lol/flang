...
| файл | строк |
|---|---:|
| `flang/src/emit/c/flang_repl.c` | 4 712 |
...
Опора: печатники, которые уже есть. `flang/self/emit-c.flang` — **3860 строк**
...
**Что сверяется побайтово сегодня** (`flang/test/self-bootstrap.test.mjs`, 1558
