...
Каталог `examples/leetcode/` — 82 файла, 7 609 строк, 300 функций и 804
исполняемых примера. Это не пример, написанный для сайта, а код в дереве.
...
298 функций из 300 объявлены словом `тотальная` — то есть несут обещание
...
А вот утверждений о **результате** на все 82 задачи — два, оба в задаче 13.
