...
|---|---|---|
| сузить тип входа | `принимает н: нат` или `целое` | никто, «не число» не втащить |
...
| `FLANG_PROOF_INDUCTION_TYPE` | по этому типу индукции нет | индукция идёт по объявленной сумме или по отрезку `нат` |
