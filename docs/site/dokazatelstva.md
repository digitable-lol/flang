...
| Как | Функций |
|---|---:|
| Композицией — рекурсии нет вовсе | 4483 |
| Структурой — обход части значения | 325 |
| Точным шагом по натуральному числу | 22 |
| Постоянным шагом с проверкой во время работы | 3 |
...
числом — **101 место у 67 функций**, — а не прячет в общий итог.

## Три ответа, а не два

Ядро отвечает тремя разными способами, и смешивать их нельзя:

**Доказано ядром** — утверждение верно про все входы. Таких **115 из 142**.
...
- [Что доказано, а что проверено](obzor.html) — граница проведена явно
- [Замер цены доказательства](zamer-tseny.html) — отчёт с числами
- [База знаний](znanie.html) — что измерено и что оказалось ложным
