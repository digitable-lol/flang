...
Все примеры-программы на flang лежат в одном каталоге — `examples/`: <!-- СНЯТО 2026-09-03 файлов examples/*.flang = 192 --> 192 файла в
...
`git ls-files examples | grep -c '\.flang$'` → <!-- СНЯТО 2026-09-03 файлов examples/*.flang = 192 --> 192 (замер 3 сентября 2026).
...
bootstrap/flang test examples/           # весь каталог, 192 файла
```
