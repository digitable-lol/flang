...
Все примеры-программы на flang лежат в одном каталоге — `examples/`: <!-- СНЯТО 2026-09-03 файлов examples/*.flang = 193 --> 193 файла в
двадцати одном наборе и одном полноразмерном проекте. Второго каталога с примерами
...
`git -c core.quotepath=false ls-files examples | grep -c '\.flang$'` → <!-- СНЯТО 2026-09-03 файлов examples/*.flang = 193 --> 193 (замер 3 сентября 2026).
...
друг от друга отличаются. Остальные двадцать один — программы: файл, а в нём
