...
Все примеры-программы на flang лежат в одном каталоге — `examples/`: <!-- СНЯТО 2026-09-08 файлов examples/*.flang = 187 --> 187 файлов в
...
`git -c core.quotepath=false ls-files examples | grep -c '\.flang$'` → <!-- СНЯТО 2026-09-08 файлов examples/*.flang = 187 --> 187 (замер 8 сентября 2026).
