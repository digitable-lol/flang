...
`check`, `run`, `test`, `repl`, `emit` во все восемь целей — это всё, что в нём
есть, и границы он называет сам, а не молчит о них:
...
любую из восьми целей — двоичный теперь тоже умеет все восемь; например, в Rust:
