...
отвечает компилятор: **тотальных функций 4936 из 6496**.
...
| | |
|---|---:|
| В корпусе | **тотальных функций 4936 из 6496** |
| О поведении | **высказано 144 утверждения**, из них **117 доказаны ядром** — про все входы |
| Аксиом в ядре | **0** |
