...
отвечает компилятор: **5954 функций из 7735** его несут.
...
| | |
|---|---:|
| Функций в корпусе | 7735 |
| Из них тотальных (завершаемость доказана) | 5954 |
| Утверждений о поведении высказано | 152 |
| Из них **доказано ядром** — про все входы | 131 |
| Аксиом в ядре | **0** |
