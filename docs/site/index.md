...
отвечает компилятор: **тотальных функций 5966 из 7747**.
...
| | |
|---|---:|
| В корпусе | **тотальных функций 5966 из 7747** |
| О поведении | **высказано 153 утверждения**, из них **132 доказаны ядром** — про все входы |
| Аксиом в ядре | **0** |
