...
отвечает компилятор: **тотальных функций 5701 из 7406**.
...
| | |
|---|---:|
| В корпусе | **тотальных функций 5701 из 7406** |
| О поведении | **высказано 152 утверждения**, из них **131 доказано ядром** — про все входы |
| Аксиом в ядре | **0** |
