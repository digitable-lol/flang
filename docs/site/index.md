...
отвечает компилятор: **тотальных функций 5621 из 7324**.
...
| | |
|---|---:|
| В корпусе | **тотальных функций 5621 из 7324** |
| О поведении | **высказано 152 утверждения**, из них **125 доказаны ядром** — про все входы |
| Аксиом в ядре | **0** |
