...
отвечает компилятор: **тотальных функций 5299 из 6972**.
...
| | |
|---|---:|
| В корпусе | **тотальных функций 5299 из 6972** |
| О поведении | **высказано 147 утверждения**, из них **120 доказаны ядром** — про все входы |
| Аксиом в ядре | **0** |
