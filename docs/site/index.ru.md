...
отвечает компилятор: **6277 функций из 8159** его несут.
...
| Из них тотальных (завершаемость доказана) | 6277 |
| Утверждений о поведении высказано | 161 |
| Из них **доказано ядром** — про все входы | 137 |
| Аксиом в ядре | **0** |
...
- **обычных функций библиотеки доказывается 7 из 20** — замер брал каждую девятую
  из всех 259, чтобы не выбирать удобные;
