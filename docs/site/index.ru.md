...
(`flang/proof/checker/checker.c`, доверенная база) переигрывает каждый шаг заново.
...
теорем в дереве языка **287**, из них **55** в стандартной библиотеке (`grep -rac '^\s*теорема ' flang
