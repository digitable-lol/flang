...
принял. Чего это **не** значит — прямо и по пунктам на странице
...
духе Isar из Isabelle, а не скрипт из тактик. Таких теорем в дереве **285**, из
них **55** в стандартной библиотеке (`grep -rac '^\s*теорема ' flang
