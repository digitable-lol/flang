...
Из итога ведомости — три строки; выше них она называет каждую функцию и каждое
...
Все шесть доказанных утверждений пришли **из библиотеки**, не отсюда: `«Знак»`,
`«Чётное»`, `«Сколько дополнить»`, `«Считать вхождения»`, `«Позиция подстроки»`,
`«Размер множества»`. То есть написать постусловие легко, а получить
