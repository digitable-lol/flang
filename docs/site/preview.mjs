...
<div class="shell">
  ...
  <main id="soderzhanie" class="content">
    <p class="preview-note"><strong>Это предпросмотр.</strong> Здесь три страницы, написанные от руки; в собранном сайте их 84, включая 62 заметки базы знаний. Пункты меню без ссылки есть в собранном сайте — соберите его командой <code>./ярлык site</code>.</p>
    ${разделы}
  </main>
</div>
<footer class="bottom">
