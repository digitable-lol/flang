...
Ответ — «проверено — разбор, типы, завершаемость, ядро и примеры; замечаний
нет» и {{планировщик.примеров}} прошедших примеров.
...
Код возврата — 2, и он значит «проверено не до конца», а не «всё хорошо».
