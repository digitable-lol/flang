...
половина из них называет предел, за который язык сегодня не ходит. Каждый отказ
ниже снят прогоном: рядом стоит программа, на которой он получается, и текст,
который на ней печатает компилятор.
