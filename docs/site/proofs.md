...
| Carrier | Functions |
|---|---:|
| By composition — no recursion at all | 6184 |
| By structure — walking part of a value | 369 |
...
its own number — **104 sites across 70 functions** — instead of folding it into
the total.
...
**Proved by the kernel** — the claim holds for all inputs. There are **168 of 297**.
...
Twenty ordinary library functions were taken — **every ninth of all 318**, so
