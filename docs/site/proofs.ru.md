...
| Принято ядром | — | **2 из 20** |

Читать эту таблицу надо так: **доказательство сегодня дороже тестов и находит
меньше**. Ещё четыре утверждения ядро закрыло только после того, как их
ослабили; если считать и их, выходит **6 из 20**. **Написанных человеком теорем
ядро не приняло ни одной.**

Первый заход дал **0 из 20**, и это оказалось самым полезным числом замера: он
показал, что упирается всё не туда, куда думали. Причина у 13 случаев из 15 была
одна — **принципа индукции не было ни у одного встроенного типа**: ни у списка,
ни у строки, ни у числа. Индукцию завели, замер повторили на тех же двадцати
функциях, и ноль стал двойкой.
