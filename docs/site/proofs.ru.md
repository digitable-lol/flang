...
| Как | Функций |
|---|---:|
| Композицией — рекурсии нет вовсе | 6184 |
| Структурой — обход части значения | 369 |
| Точным шагом по натуральному числу | 27 |
| Постоянным шагом с проверкой во время работы | 6 |
...
числом — **104 место у 70 функций**, — а не прячет в общий итог.

## Три ответа, а не два

Ядро отвечает тремя разными способами, и смешивать их нельзя:

**Доказано ядром** — утверждение верно про все входы. Таких **168 из 297**.
...
Взяли двадцать обычных функций библиотеки — **каждую девятую из всех 318**, чтобы
