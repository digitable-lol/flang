...
| Как | Функций |
|---|---:|
| Композицией — рекурсии нет вовсе | 5822 |
| Структурой — обход части значения | 359 |
| Точным шагом по натуральному числу | 27 |
| Постоянным шагом с проверкой во время работы | 5 |
...
числом — **103 место у 69 функций**, — а не прячет в общий итог.

## Три ответа, а не два

Ядро отвечает тремя разными способами, и смешивать их нельзя:

**Доказано ядром** — утверждение верно про все входы. Таких **137 из 161**.
...
Взяли двадцать обычных функций библиотеки — **каждую девятую из всех 259**, чтобы
