  ...
  },
  {
    ...
    страницы: [
      /* ПОРЯДОК ЗДЕСЬ — ОТ ТОГО, ЧТО ПИШУТ, К ТОМУ, ЧЕМ ЭТО ЗАКРЕПЛЕНО.
         ...
         СНЯТО 2026-09-08 строк flang/SPEC.md = 1737
  ...
  },
  {
    ...
    страницы: [
      /* СПЕЦИФИКАЦИЯ ЯДРА ПЕРЕЕХАЛА СЮДА ИЗ РАЗДЕЛА «ДОКАЗАТЕЛЬСТВА», где стояла
         ...
         соседей по этому разделу: контракт на 4670 строк, где рядом с правилом
         СНЯТО 2026-09-08 строк flang/proof/SPEC.md = 4670
      ...
      { адрес: 'spec-self.html', имя: 'Самоприменение: компилятор на flang — контракт', из: 'flang/self/SPEC.md' },
    ],
  },
  {
