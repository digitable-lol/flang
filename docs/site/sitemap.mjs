...
export const РАЗДЕЛЫ = [
  ...
  },
  {
    ...
    // и rust, и повод тот же: читателю нужно «что приехало в версию, которую я
    // ставлю», а не хроника чужой работы. Журналы вливаний и коммитов никуда не
    // делись — они уехали в раздел для тех, кто развивает язык, потому что там
    // их и читают.
