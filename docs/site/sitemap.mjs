  ...
  },
  {
    ...
    страницы: [
      /* ПОРЯДОК ЗДЕСЬ — ОТ ТОГО, ЧТО ПИШУТ, К ТОМУ, ЧЕМ ЭТО ЗАКРЕПЛЕНО.
         ...
         «Язык». Она не введение: это контракт на 2016 строк, где рядом с формой
         СНЯТО 2026-09-02 строк flang/SPEC.md = 2016
  ...
  },
  {
    ...
    страницы: [
      ...
      /* Спецификация языка стояла в разделе «Язык» последним пунктом и читалась
         как справка для пишущего. Это не справка: контракт на 2016 строк, где
         СНЯТО 2026-09-02 строк flang/SPEC.md = 2016
