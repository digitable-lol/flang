...
export const РАЗДЕЛЫ = [
  ...
  },
  {
    ...
    // раньше не было, теперь есть: `flang io scripts/site/releases-page.flang`.
    имя: 'Что изменилось', англ: 'What changed',
    страницы: [
      // `печатается` снимает требование английской пары ИЗ КАРТЫ: обе половины
      // печатает `flang io scripts/site/releases-page.flang` из тегов и заметок
  ...
  },
  {
    ...
    страницы: [
      /* СПЕЦИФИКАЦИЯ ЯДРА ПЕРЕЕХАЛА СЮДА ИЗ РАЗДЕЛА «ДОКАЗАТЕЛЬСТВА», где стояла
         ...
         соседей по этому разделу: контракт на 4810 строк, где рядом с правилом
         СНЯТО 2026-09-15 строк docs/flang/proof/SPEC.md = 4810
  ...
  },
  {
    /* РАЗДЕЛ ПЕРЕЕХАЛ СО ВТОРОГО МЕСТА В КОНЕЦ, и довод, стоявший здесь раньше
       ...
       по тегам. Теперь такая печать есть: `flang io scripts/site/releases-page.flang`
