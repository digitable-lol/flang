  ...
  },
  {
    ...
    страницы: [
      /* ПОРЯДОК ЗДЕСЬ — ОТ ТОГО, ЧТО ПИШУТ, К ТОМУ, ЧЕМ ЭТО ЗАКРЕПЛЕНО.
         ...
         «Язык». Она не введение: это контракт на 1737 строк, где рядом с формой
         СНЯТО 2026-09-08 строк docs/flang/SPEC.md = 1737
  ...
  },
  {
    ...
    страницы: [
      /* СПЕЦИФИКАЦИЯ ЯДРА ПЕРЕЕХАЛА СЮДА ИЗ РАЗДЕЛА «ДОКАЗАТЕЛЬСТВА», где стояла
         ...
         соседей по этому разделу: контракт на 4699 строк, где рядом с правилом
         СНЯТО 2026-09-11 строк docs/flang/proof/SPEC.md = 4699
      ...
      /* Спецификация языка стояла в разделе «Язык» последним пунктом и читалась
         как справка для пишущего. Это не справка: контракт на 1737 строк, где
         СНЯТО 2026-09-08 строк docs/flang/SPEC.md = 1737
