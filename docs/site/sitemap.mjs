...
export const РАЗДЕЛЫ = [
  {
    ...
    страницы: [
      ...
      // Имя пункта = заголовок страницы. Страница называлась «Роадмап» и была
      // отчётом о проделанной работе: размер собранного файла, время сборки,
      // сравнения байт в байт. План — это то, чего ещё НЕТ, и страница переписана
      // им; пункт назван так же, чтобы читатель не гадал, куда попадёт.
  ...
  },
  {
    ...
    имя: 'Тем, кто развивает язык', англ: 'For contributors',
    страницы: [
