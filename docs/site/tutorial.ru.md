...
Все программы учебника лежат одним файлом — в репозитории языка. Поставившему
`flang` через Homebrew или asdf этого файла на машине нет, и это не помеха:
каждая программа ниже показана целиком, её можно просто перепечатать в свой
файл. Прогнать же весь учебник разом можно из клона дерева:
