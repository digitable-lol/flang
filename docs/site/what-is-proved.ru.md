...
Числа этой таблицы сняты прогоном по корпусу, но команды, которой их
воспроизвести сегодня, в дереве нет, и отдельной записи о том прогоне в базе
знаний тоже. Соседняя запись
