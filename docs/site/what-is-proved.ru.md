...
доводом командной строки: оно участвует в побайтовом совпадении при самосборке, и
двоичный, собранный с другим пределом, перестал бы печатать сам себя. Процедура
записана в шапке `scripts/raskrutka.sh`.
