...
### Содержательных утверждений — 9 из 20
...
| | Утверждений |
|---|---:|
| Содержательных — при заглушке отпадают | **9** |
| Ослабленных — доказаны и при заглушке | 5 |
| Даровых — тело переписано в постусловие | 1 |
| Не проверено — заглушки для такого типа нет | 1 |

Хоть что-нибудь доказано у 13 функций из 20. Содержательно — у 5.
