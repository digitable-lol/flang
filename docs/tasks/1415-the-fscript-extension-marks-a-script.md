...
названо в списках 31
  · flang/proof/checker/tests/families/run-induction/letters.запись
```
...
`flang/proof/checker/tests/families/run-induction/letters.запись` в «Места отбора» и
...
| 30 | `…/run-induction/letters.запись` | запись доказательства называет исходник `letters.фп` (2) | Д | не правится: файл без плана |
