...
названо в списках 31
  · flang/proof/checker/tests/families/run-induction/письма.запись
```
...
`flang/proof/checker/tests/families/run-induction/письма.запись` в «Места отбора» и
...
| 30 | `…/run-induction/письма.запись` | запись доказательства называет исходник `письма.фп` (2) | Д | не правится: файл без плана |
