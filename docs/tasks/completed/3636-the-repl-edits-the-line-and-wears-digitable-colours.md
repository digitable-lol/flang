...
Перенесена в `docs/tasks/completed/` 8 сентября 2026: статус был «сделана», а файл
лежал среди открытых — доска считала её незакрытой работой. `394b2607` в стволе
есть и в `gh/dev` влит (`git merge-base --is-ancestor 394b2607 gh/dev` → 0).
