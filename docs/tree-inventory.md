# Опись дерева по языкам: 279 файлов вне flang, долг вне JavaScript — 107 при потолке 63
<!-- СНЯТО 2026-09-07 файлов *.sh,*.c,*.h,*.py,*.html,*.css,*.awk,*.erl,*.js,*.mjs,*.java,*.cs,*.ex,*.exs,*.go,*.rs,*.lua,*.vim,*.rb,*.cpp,*.cc,*.hpp,*.hh,ярлык,packaging/asdf/bin/download,packaging/asdf/bin/install,packaging/asdf/bin/list-all,.githooks/pre-push = 279 -->
...
|---|---:|---:|---:|---:|
| оболочка | 106 | 20 581 | 90 | 11 645 <!-- СНЯТО 2026-09-06 файлов *.sh,ярлык,packaging/asdf/bin/download,packaging/asdf/bin/install,packaging/asdf/bin/list-all,.githooks/pre-push = 106 --><!-- СНЯТО 2026-09-07 строк-в *.sh,ярлык,packaging/asdf/bin/download,packaging/asdf/bin/install,packaging/asdf/bin/list-all,.githooks/pre-push = 20581 --> |
| C | 38 | 780 513 | 0 | 0 <!-- СНЯТО 2026-09-06 файлов *.c,*.h = 38 --><!-- СНЯТО 2026-09-07 строк-в *.c,*.h = 780513 --> |
...
| JavaScript | 66 | 31 525 | считает [`javascript-inventory.md`](javascript-inventory.md) <!-- СНЯТО 2026-09-07 файлов *.js,*.mjs = 66 --><!-- СНЯТО 2026-09-07 строк-в *.js,*.mjs = 31525 --> ||
