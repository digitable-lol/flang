...
| C | 38 | 782 377 | 0 | 0 <!-- СНЯТО 2026-09-06 файлов *.c,*.h = 38 --><!-- СНЯТО 2026-09-08 строк-в *.c,*.h = 782377 --> |
...
Три четверти миллиона строк C — это не долг и даже не почти долг: 609 584 из
них — `bootstrap/compiler_flang.c`, то есть сам компилятор, напечатанный из
flang в C.
<!-- СНЯТО 2026-09-07 строк bootstrap/compiler_flang.c = 609584 -->
