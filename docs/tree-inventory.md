...
|---|---:|---:|---:|---:|
| оболочка | 98 | 23 875 | 87 | 15 614 <!-- СНЯТО 2026-09-12 долг файлов/строк оболочки = 87/15614, планом «Опись дерева по языкам» на стволе 24e6edb33 со слитой уборкой дерева (учебник прибавил 37 строк в scripts/flangtutor-proba.sh, хук — 5 строк в .githooks/pre-push; до них на 4e9a7a8c3 было 102/16682) (8 сентября было 98/15001: задача 3127 завела scripts/module-origin-guard.sh, 277 строк) --><!-- СНЯТО 2026-09-13 файлов *.sh,ярлык,packaging/asdf/bin/download,packaging/asdf/bin/install,packaging/asdf/bin/list-all,.githooks/pre-push = 98 --><!-- СНЯТО 2026-09-13 строк-в *.sh,ярлык,packaging/asdf/bin/download,packaging/asdf/bin/install,packaging/asdf/bin/list-all,.githooks/pre-push = 23875 --> |
