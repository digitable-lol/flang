...
|---|---:|---:|---:|---:|
| оболочка | 106 | 20 702 | 90 | 11 645 <!-- СНЯТО 2026-09-06 файлов *.sh,ярлык,packaging/asdf/bin/download,packaging/asdf/bin/install,packaging/asdf/bin/list-all,.githooks/pre-push = 106 --><!-- СНЯТО 2026-09-08 строк-в *.sh,ярлык,packaging/asdf/bin/download,packaging/asdf/bin/install,packaging/asdf/bin/list-all,.githooks/pre-push = 20702 --> |
...
| JavaScript | 69 | 33 391 | считает [`javascript-inventory.md`](javascript-inventory.md) <!-- СНЯТО 2026-09-06 файлов *.js,*.mjs = 69 --><!-- СНЯТО 2026-09-08 строк-в *.js,*.mjs = 33391 --> ||
