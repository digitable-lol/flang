# Опись дерева по языкам: 248 файлов вне flang, долг вне JavaScript — 97 при потолке 63
<!-- СНЯТО 2026-09-17 файлов *.sh,*.c,*.h,*.py,*.html,*.css,*.awk,*.erl,*.js,*.mjs,*.java,*.cs,*.ex,*.exs,*.go,*.rs,*.lua,*.vim,*.rb,*.cpp,*.cc,*.hpp,*.hh,ярлык,packaging/asdf/bin/download,packaging/asdf/bin/install,packaging/asdf/bin/list-all,.githooks/pre-push = 248 -->
...
| JavaScript | 50 | 23 387 | считает [`javascript-inventory.md`](javascript-inventory.md) <!-- СНЯТО 2026-09-15 файлов *.js,*.mjs = 50 --><!-- СНЯТО 2026-09-17 строк-в *.js,*.mjs = 23387 --> ||
