# Опись дерева по языкам: 273 файлов вне flang, долг вне JavaScript — 107 при потолке 63
<!-- СНЯТО 2026-09-06 файлов *.sh,*.c,*.h,*.py,*.html,*.css,*.awk,*.erl,*.js,*.mjs,*.java,*.cs,*.ex,*.exs,*.go,*.rs,*.lua,*.vim,*.rb,*.cpp,*.cc,*.hpp,*.hh,ярлык,packaging/asdf/bin/download,packaging/asdf/bin/install,packaging/asdf/bin/list-all,.githooks/pre-push = 273 -->
...
| C | 38 | 770 230 | 0 | 0 <!-- СНЯТО 2026-09-04 файлов *.c,*.h = 38 --><!-- СНЯТО 2026-09-06 строк-в *.c,*.h = 770230 --> |
| C++ | 1 | 404 | 0 | 0 <!-- СНЯТО 2026-09-05 файлов *.cpp,*.cc,*.hpp,*.hh = 1 --><!-- СНЯТО 2026-09-05 строк-в *.cpp,*.cc,*.hpp,*.hh = 404 --> |
| Python | 22 | 7 758 | 16 | 3 843 <!-- СНЯТО 2026-09-05 файлов *.py = 22 --><!-- СНЯТО 2026-09-06 строк-в *.py = 7758 --> |
...
Три четверти миллиона строк C — это не долг и даже не почти долг: 603 107 из
них — `bootstrap/compiler_flang.c`, то есть сам компилятор, напечатанный из
flang в C.
<!-- СНЯТО 2026-09-06 строк bootstrap/compiler_flang.c = 603107 -->
...
|---|---|---:|---:|
| напечатано самим компилятором | `bootstrap/**` — шесть файлов на C, вывод печати | 6 | 732 057 <!-- СНЯТО 2026-08-31 файлов bootstrap/*.c,bootstrap/*.h = 6 --><!-- СНЯТО 2026-09-06 строк-в bootstrap/*.c,bootstrap/*.h = 732057 --> |
| рантайм цели печати | `flang/src/emit/{c,cpp,python,java,csharp,elixir,go,rust}/**` — уезжает в напечатанную программу дословно | 28 | 46 296 <!-- СНЯТО 2026-09-05 файлов flang/src/emit/c/*,flang/src/emit/cpp/*,flang/src/emit/python/*,flang/src/emit/java/*,flang/src/emit/csharp/*,flang/src/emit/elixir/*,flang/src/emit/go/*,flang/src/emit/rust/* = 28 --><!-- СНЯТО 2026-09-06 строк-в flang/src/emit/c/*,flang/src/emit/cpp/*,flang/src/emit/python/*,flang/src/emit/java/*,flang/src/emit/csharp/*,flang/src/emit/elixir/*,flang/src/emit/go/*,flang/src/emit/rust/* = 46296 --> |
