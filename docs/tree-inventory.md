...
|---|---:|---:|---:|---:|
| оболочка | 107 | 20 866 | 90 | 11 645 <!-- СНЯТО 2026-09-08 файлов *.sh,ярлык,packaging/asdf/bin/download,packaging/asdf/bin/install,packaging/asdf/bin/list-all,.githooks/pre-push = 107 --><!-- СНЯТО 2026-09-08 строк-в *.sh,ярлык,packaging/asdf/bin/download,packaging/asdf/bin/install,packaging/asdf/bin/list-all,.githooks/pre-push = 20866 --> |
...
| JavaScript | 68 | 33 106 | считает [`javascript-inventory.md`](javascript-inventory.md) <!-- СНЯТО 2026-09-08 файлов *.js,*.mjs = 68 --><!-- СНЯТО 2026-09-08 строк-в *.js,*.mjs = 33106 --> ||
