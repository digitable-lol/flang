...
|---|---:|---:|---:|---:|
| оболочка | 107 | 21 069 | 96 | 14 267 <!-- СНЯТО 2026-09-08 долг файлов/строк оболочки = 96/14267, планом «Опись дерева по языкам» (было 90/11 645 на 5 сентября) --><!-- СНЯТО 2026-09-08 файлов *.sh,ярлык,packaging/asdf/bin/download,packaging/asdf/bin/install,packaging/asdf/bin/list-all,.githooks/pre-push = 107 --><!-- СНЯТО 2026-09-08 строк-в *.sh,ярлык,packaging/asdf/bin/download,packaging/asdf/bin/install,packaging/asdf/bin/list-all,.githooks/pre-push = 21069 --> |
| C | 38 | 782 795 | 0 | 0 <!-- СНЯТО 2026-09-06 файлов *.c,*.h = 38 --><!-- СНЯТО 2026-09-08 строк-в *.c,*.h = 782795 --> |
