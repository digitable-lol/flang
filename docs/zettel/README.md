...
- [Про планировщик ядро закрывает ровно один род утверждений — замкнутую цель](what-the-kernel-can-prove-about-a-scheduler.md)
...
- [Два эталона одного файла, выросшие порознь, бывают не соперниками, а половинами](two-etalons-of-one-file-may-be-halves.md)
