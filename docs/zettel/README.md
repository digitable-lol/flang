...
- [Признак «печатать отдельным файлом» — это «во вкладку не едет», а не «одинаково для всех программ»](ispolnitel-plana-pechataetsya-vnutr-modulya-a-progonshchik-ryadom.md) — и вторая половина: сверка, зеленеющая на слове вместо объявления
