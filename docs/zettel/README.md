...
- [Без блока «Граница входа» напечатанный C# собирается, но падает при запуске: у пяти целей печати этого блока нет](granica-vhoda-ne-napisana-u-pyati-celey-i-eto-vidno-tolko-syrym-diffom.md)
