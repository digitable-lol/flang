...
- [У строки flang ДВЕ меры, и встроенные формы поделены между ними — отсюда весь класс «ложно на одиноком суррогате»](dve-mery-stroki-delyat-vstroennye-formy.md)
