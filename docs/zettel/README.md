...
- [Идущая программа сама пишет, где она: пульс в файл раз в пять миллионов вызовов, и возражение объёмом было завышено в тысячу раз](a-running-program-writes-its-own-pulse-to-a-file.md)
