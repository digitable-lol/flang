...
- [Цена, названная в единицах работы, читается дешевле, чем она есть: «один разбор входного файла» стоил 21,7 с при 0,00 с у того, ради чего платился](a-cost-named-in-work-units-reads-cheaper-than-it-is.md)
