...
[[other-peoples-packages-must-be-stored]], и ровно тот довод, что в
[[code-cannot-be-derived-from-its-hash]].
...
- **Схема живёт и ломается.** Версия схемы 26 при 22 инкрементальных миграциях, и
  ...
  [[the-unison-diamond-breaks-on-a-type-edit-not-a-version-bump]].

Связано: [[unison-measured]], [[the-unison-diamond-breaks-on-a-type-edit-not-a-version-bump]],
[[code-cannot-be-derived-from-its-hash]], [[other-peoples-packages-must-be-stored]],
[[content-addressing]]
