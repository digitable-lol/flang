...
| `хвост` | копия суффикса (срез без копии в C и Rust) | тот же список без первой ячейки, даром; после `добавить` — разворот накопленного конца один раз на всю цепочку |
