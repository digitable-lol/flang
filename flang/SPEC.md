...
назван в `DESCRIPTION.md` и в таблице долга двоичного.
...
<!-- СНЯТО 2026-09-11 список flang/self/parser.flang:6589 = 22 -->
...
flang/self/            компилятор, написанный на flang: слои и их роли —
                       в flang/self/SPEC.md, состав каталога там же
...
Состав `flang/self/` здесь не перечисляется: он живёт в `flang/self/SPEC.md`
...
своя страница: доказательства (`FLANG_PROOF_*`, `flang/proof/SPEC.md`), ввоз
...
числом и разобран в `DESCRIPTION.md`; на `вес минус вес` двоичный отвечает
«замечаний нет».
