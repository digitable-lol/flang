...
Поверхность не обязана быть полной. У пяти понятий из 131 слова на какой-то из
поверхностей нет, и это записано в самой таблице поимённо с причиной: выбор
слова в языке — решение владельца, а не подстановка из словаря. Файл на такой
поверхности пишет недостающее понятие словом другой (`examples/surfaces`).
