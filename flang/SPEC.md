...
Строку про `хвост` стережёт `flang/test/emit-guard.test.mjs`: у каждой из восьми
целей он держит точный кусок её рантайма и класс — срез или копия, — и требует,
чтобы скобка называла ровно те цели, что берут срез. До него скобка называла
