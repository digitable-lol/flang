...
шаг и ограниченный снизу. Не доказал — ошибка `FLANG_NOT_TOTAL`.
...
{ "kind": "builtin",  "name": "длина|символ|символы|подстрока|соединить|разделить|содержит|к числу или беда|…", "args": [Expr] }
```
