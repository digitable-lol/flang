...
одинаково», — а точки, на которых бюджет шагов у эталона и у цели расходится
...
с эталоном побайтовая (восемь сверок близнеца с эталоном), и программа с
...
устройство сегодняшнего эталона, и только здесь названы его файлы.

Эталон написан на JavaScript, и это **сегодняшнее** состояние, а не свойство
языка: близнецы в `flang/self/` — тот же компилятор, написанный на самом flang —
уже печатают в восемь целей и сверяются с эталоном побайтово. Разделы про язык на
файлы эталона не ссылаются намеренно: расширение файла — про сегодняшнюю
