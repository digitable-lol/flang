...
### Словарь поручений — восемь действий, и набор закрыт
...
**Восемь поручений, и набор закрыт** — это утверждение, а не текущее состояние.
Полнота здесь дороже, чем кажется: каждое поручение обязан уметь исполнить
КАЖДЫЙ хозяин, включая напечатанного в C.

Долго их было пять, и цена шестого называлась так: «либо писать восемь раз, либо
