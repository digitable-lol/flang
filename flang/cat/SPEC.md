...
### Словарь поручений — шесть действий, и набор закрыт
...
поручения, а цикла хозяина и всех пяти прежних. Шестое стоило одного
исполнителя, а не восьми (`fspec/README.md`).

Шестое заведено не «для полноты», а под названную работу: сторож спек обязан
НАЙТИ спеки в каталоге, а прочитать можно только названный файл.
