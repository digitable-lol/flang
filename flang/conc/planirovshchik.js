...
export const $PROGRAM = {
  ...
  entry: {
    types: [
      { kind: "список", name: "список «Процесс»", owner: "", nothing: false, integer: false, range: false, low: 0, high: 0, item: 1, fieldAt: 0, fieldCount: 0, variantAt: 0, variantCount: 0 },
      { kind: "запись", name: "«Процесс»", owner: "Процесс", nothing: false, integer: false, range: false, low: 0, high: 0, item: 0, fieldAt: 2, fieldCount: 8, variantAt: 0, variantCount: 0 },
      ...
      { kind: "список", name: "список «Письмо»", owner: "", nothing: false, integer: false, range: false, low: 0, high: 0, item: 6, fieldAt: 0, fieldCount: 0, variantAt: 0, variantCount: 0 },
      { kind: "запись", name: "«Письмо»", owner: "Письмо", nothing: false, integer: false, range: false, low: 0, high: 0, item: 0, fieldAt: 0, fieldCount: 2, variantAt: 0, variantCount: 0 },
      { kind: "запись", name: "«Узел»", owner: "Узел", nothing: false, integer: false, range: false, low: 0, high: 0, item: 0, fieldAt: 10, fieldCount: 6, variantAt: 0, variantCount: 0 },
      { kind: "список", name: "список строки", owner: "", nothing: false, integer: false, range: false, low: 0, high: 0, item: 2, fieldAt: 0, fieldCount: 0, variantAt: 0, variantCount: 0 },
      { kind: "сумма", name: "«Исход доставки»", owner: "Исход доставки", nothing: false, integer: false, range: false, low: 0, high: 0, item: 0, fieldAt: 0, fieldCount: 0, variantAt: 0, variantCount: 3 },
      ...
      { kind: "сумма", name: "«Что случилось с узлом»", owner: "Что случилось с узлом", nothing: false, integer: false, range: false, low: 0, high: 0, item: 0, fieldAt: 0, fieldCount: 0, variantAt: 8, variantCount: 7 },
      { kind: "список", name: "список «Действие узла»", owner: "", nothing: false, integer: false, range: false, low: 0, high: 0, item: 13, fieldAt: 0, fieldCount: 0, variantAt: 0, variantCount: 0 },
      { kind: "сумма", name: "«Действие узла»", owner: "Действие узла", nothing: false, integer: false, range: false, low: 0, high: 0, item: 0, fieldAt: 0, fieldCount: 0, variantAt: 3, variantCount: 5 },
      { kind: "запись", name: "«Ход узла»", owner: "Ход узла", nothing: false, integer: false, range: false, low: 0, high: 0, item: 0, fieldAt: 49, fieldCount: 2, variantAt: 0, variantCount: 0 },
      { kind: "список", name: "список «Веление узлу»", owner: "", nothing: false, integer: false, range: false, low: 0, high: 0, item: 16, fieldAt: 0, fieldCount: 0, variantAt: 0, variantCount: 0 },
      { kind: "сумма", name: "«Веление узлу»", owner: "Веление узлу", nothing: false, integer: false, range: false, low: 0, high: 0, item: 0, fieldAt: 0, fieldCount: 0, variantAt: 15, variantCount: 6 },
    ],
    fields: [
      { name: "билет", type: 4 },
      { name: "начатое", type: 3 },
      ...
      { name: "ящик", type: 5 },
      { name: "имя", type: 2 },
      { name: "процессы", type: 0 },
      { name: "связи", type: 8 },
      { name: "кто бежит", type: 2 },
      { name: "что бежит", type: 4 },
      { name: "работает", type: 3 },
      { name: "кому", type: 2 },
      { name: "билет", type: 4 },
      { name: "кому", type: 2 },
      { name: "билет", type: 4 },
      { name: "задержка", type: 4 },
      { name: "почему", type: 2 },
      { name: "кому", type: 2 },
      { name: "билет", type: 4 },
      { name: "действия", type: 12 },
      { name: "код", type: 2 },
      { name: "текст", type: 2 },
      { name: "кому", type: 2 },
      { name: "билет", type: 4 },
    ...
    variants: [
      ...
      { name: "Таймер сработал", fieldAt: 27, fieldCount: 2 },
      { name: "Связь готова", fieldAt: 29, fieldCount: 1 },
      { name: "Связь потеряна", fieldAt: 30, fieldCount: 2 },
      { name: "Пора бежать", fieldAt: 32, fieldCount: 1 },
      { name: "Позвать обработчик", fieldAt: 33, fieldCount: 2 },
      { name: "Послать по проводу", fieldAt: 35, fieldCount: 3 },
      { name: "Поставить таймер", fieldAt: 38, fieldCount: 3 },
      { name: "Записать в журнал", fieldAt: 41, fieldCount: 3 },
      { name: "Уронить процесс", fieldAt: 44, fieldCount: 3 },
      { name: "Письмо пропало", fieldAt: 47, fieldCount: 2 },
    ],
    params: [
      { fn: "Первый процесс", name: "процессы", type: 0 },
      { fn: "Найти процесс", name: "процессы", type: 0 },
      { fn: "Найти процесс", name: "имя", type: 2 },
      { fn: "Заменить процесс", name: "процессы", type: 0 },
      { fn: "Заменить процесс", name: "новый", type: 1 },
      { fn: "С процессом", name: "узел", type: 7 },
      { fn: "С процессом", name: "новый", type: 1 },
      { fn: "Узел с ходом", name: "узел", type: 7 },
      { fn: "Узел с ходом", name: "кто бежит", type: 2 },
      { fn: "Узел с ходом", name: "что бежит", type: 4 },
      { fn: "Узел со связями", name: "узел", type: 7 },
      { fn: "Узел со связями", name: "связи", type: 8 },
      { fn: "Процесс заново", name: "имя", type: 2 },
      { fn: "Процесс заново", name: "свой", type: 3 },
      { fn: "Процесс заново", name: "на каком", type: 2 },
      { fn: "Процесс заново", name: "жив", type: 3 },
      { fn: "Процесс заново", name: "причина", type: 2 },
      { fn: "Процесс заново", name: "потолок", type: 4 },
      { fn: "Процесс заново", name: "в лёте", type: 4 },
      { fn: "Процесс заново", name: "ящик", type: 5 },
      { fn: "С ящиком", name: "процесс", type: 1 },
      { fn: "С ящиком", name: "ящик", type: 5 },
      { fn: "Умертвить", name: "процесс", type: 1 },
      { fn: "Умертвить", name: "причина", type: 2 },
      { fn: "Ящик полон", name: "процесс", type: 1 },
      { fn: "В ящик", name: "ящик", type: 5 },
      { fn: "В ящик", name: "письмо", type: 6 },
      { fn: "В ящик", name: "вперёд", type: 3 },
      { fn: "Исход положить", name: "узел", type: 7 },
      { fn: "Исход положить", name: "кому", type: 2 },
      { fn: "Исход положить", name: "место занято", type: 3 },
      { fn: "Легло ли", name: "исход", type: 9 },
      { fn: "Положить", name: "узел", type: 7 },
      { fn: "Положить", name: "кому", type: 2 },
      { fn: "Положить", name: "билет", type: 4 },
      { fn: "Положить", name: "вперёд", type: 3 },
      { fn: "Положить", name: "место занято", type: 3 },
      { fn: "Положить", name: "начатое", type: 3 },
      { fn: "Связь есть", name: "узел", type: 7 },
      { fn: "Связь есть", name: "с кем", type: 2 },
      { fn: "Отправить", name: "узел", type: 7 },
      { fn: "Отправить", name: "кому", type: 2 },
      { fn: "Отправить", name: "билет", type: 4 },
      { fn: "Отправить найденному", name: "узел", type: 7 },
      { fn: "Отправить найденному", name: "п", type: 1 },
      { fn: "Отправить найденному", name: "билет", type: 4 },
      { fn: "Отправить своему", name: "узел", type: 7 },
      { fn: "Отправить своему", name: "п", type: 1 },
      { fn: "Отправить своему", name: "билет", type: 4 },
      { fn: "Почему ящик полон", name: "кому", type: 2 },
      { fn: "Отправить чужому", name: "узел", type: 7 },
      { fn: "Отправить чужому", name: "п", type: 1 },
      { fn: "Отправить чужому", name: "билет", type: 4 },
      { fn: "Готовые", name: "узел", type: 7 },
      { fn: "Номер по жребию", name: "сколько", type: 4 },
      { fn: "Номер по жребию", name: "жребий", type: 10 },
      { fn: "Целая часть", name: "х", type: 10 },
      { fn: "Не больше", name: "что", type: 10 },
      { fn: "Не больше", name: "предел", type: 10 },
      { fn: "Шаг узла", name: "узел", type: 7 },
      { fn: "Шаг узла", name: "что", type: 11 },
      { fn: "Письмо с провода", name: "узел", type: 7 },
      { fn: "Письмо с провода", name: "кому", type: 2 },
      { fn: "Письмо с провода", name: "билет", type: 4 },
      { fn: "Пробежать", name: "узел", type: 7 },
      { fn: "Пробежать", name: "жребий", type: 10 },
      { fn: "Пробежать выбранного", name: "узел", type: 7 },
      { fn: "Пробежать выбранного", name: "п", type: 1 },
      { fn: "Первое письмо", name: "ящик", type: 5 },
      { fn: "Отклик разобран", name: "узел", type: 7 },
      { fn: "Отклик разобран", name: "действия", type: 12 },
      { fn: "Слить ход", name: "ход", type: 14 },
      { fn: "Слить ход", name: "новый", type: 14 },
      { fn: "Одно действие", name: "ход", type: 14 },
      { fn: "Одно действие", name: "д", type: 13 },
      { fn: "Одно действие", name: "кто", type: 2 },
      { fn: "Одно действие", name: "что", type: 4 },
      { fn: "Остановить", name: "ход", type: 14 },
      { fn: "Остановить", name: "кто", type: 2 },
      { fn: "Остановить", name: "почему", type: 2 },
      { fn: "Пробег сорвался", name: "узел", type: 7 },
      { fn: "Пробег сорвался", name: "код", type: 2 },
      { fn: "Пробег сорвался", name: "текст", type: 2 },
    ],
  },
}
