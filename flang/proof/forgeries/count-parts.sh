...
#
#   sh flang/proof/forgeries/count-parts.sh
...
LOZH=$KOREN/flang/proof/forgeries/part-count-false.flang
PRAVDA=$KOREN/flang/proof/forgeries/part-count-true.flang
