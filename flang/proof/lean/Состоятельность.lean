...
Теорема доказана для 66 правил приёмки (`«покрыто» = 66`, проверено
`decide`) из 73 приёмов `шаг_вывода`; из 15 именованных — для 14 (без Разв1).
...
theorem «покрыто-число» : «покрыто» = 66 := by decide
