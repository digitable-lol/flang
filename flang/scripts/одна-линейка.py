...
(`flang/scripts/kernel-lines-to-trust.fscript`):
...
НЕ второе мнение. Это перенос определения из kernel-lines-to-trust.fscript;
...
ПРОИСХОЖДЕНИЕ МЕРКИ. Дословный перенос `flang/scripts/kernel-lines-to-trust.fscript`
...
ЧЕГО ЭТА МЕРКА НЕ ДОКАЗЫВАЕТ (сказано прямо, чтобы не выдали за большее):
  • Она НЕ независимое подтверждение. Это перенос определения из
    kernel-lines-to-trust.fscript, той же породы, что shire.py: ловит описку в
