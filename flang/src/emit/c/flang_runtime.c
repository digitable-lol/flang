 ...
 *
 *   витков   пик до    пик после
 *   100 000   7,99 ГиБ   0,03 ГиБ
 *   200 000  15,98 ГиБ   0,03 ГиБ
 *   400 000  снят пределом 20 ГиБ   0,03 ГиБ
 *
 * То есть 84 килобайта на виток и рост строго линейный: считать в интерпретаторе
 * миллион витков было нельзя ни на какой машине. Пик снимался ядром
 * (`memory.peak` контрольной группы), а не `ps`.
 *
