...
/*
 * Арена плюс счётчик глубины. Счётчик — не украшение: нехвостовая рекурсия в C
 * идёт по настоящему стеку, и его переполнение это не исключение, а падение
 * процесса. Интерпретатор в том же месте даёт FLANG_RECURSION_LIMIT, и
 * сгенерированный код обязан давать его же.
 */
