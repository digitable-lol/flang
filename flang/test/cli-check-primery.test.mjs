 ...
 *
 * Корпус дерева ДО правки (801 файл `.flang`, ствол `0c2880d5`): прогнано
 * 7779 примеров, не сошлось 17 в 13 файлах, и `flang check` не отвергал ни
 * одного из тринадцати. После правки краснеют ровно эти тринадцать — ни одним
 * больше и ни одним меньше. Цена: сумма времени `check` по всем 801 файлу
 * 312,2 с → 383,5 с, медиана роста на файл 1 мс.
 *
