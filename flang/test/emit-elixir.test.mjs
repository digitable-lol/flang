...
test("−0 не печатается литералом ни в одном файле Elixir: до OTP 27 его сливают с 0", () => {
  ...
  assert.deepEqual([...checked].sort(),
    ["flang_cli.ex", "flang_conc.ex", "flang_runtime.ex", "schyotchik_i_zhurnal.ex", "znak_nulya.ex"],
    "просмотрен обязан быть весь печатаемый Elixir, включая рантайм конкурентности")
