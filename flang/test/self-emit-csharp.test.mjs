...
function напечатать(ast, опции = {}) {
  const итог = вызвать("Печать программы CSharp", { "программа": значение(ast), "настройки": настройки(ast, опции) })
...
function расхождение(имя, ast, опции = {}) {
  ...
  /* ДОЛГ ЭТАЛОНА СНЯТ, И ВЫЧИТАНИЕ УБРАНО.
     ...
     — «Печать границы входа CSharp» есть в эталоне, таблица приезжает
