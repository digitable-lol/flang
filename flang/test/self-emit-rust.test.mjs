...
function расхождение(имя, ast, опции = {}) {
  ...
  if (блоковГраницы === 0 && свидетель.files.some((файл) => файл.content.length > 400)) {
    return `${имя}: свидетель не напечатал границы входа ни в одном файле — вычитание стало прикрытием, снимите его`
  }
  return null
}
