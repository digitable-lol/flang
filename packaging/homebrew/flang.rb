...
class Flang < Formula
  ...
  url "https://github.com/digitable-lol/flang/releases/download/v0.7.5/flang-0.7.5-c.tar.gz"
  ...
  # лишь тегов; сухого прогона до метки этим приёмом больше нет. v0.7.4
  # поймала это на себе: число ниже стояло от 0.7.3, конвейер сверил его
  # с собственной сборкой на теге и остановился ДО публикации (сам же
  # прибор и назвал настоящий хеш в тексте ошибки) — тег не удалялся,
  # просто пропущен, как v0.7.1/v0.7.2 до него. Число ниже для v0.7.5
  # снято ЛОКАЛЬНО — той же командой, что описана выше, дословно — а не
  # руками пересчитано другим способом; сверит его сам конвейер на теге.
  ...
  # для 0.7.5 — задача 9983). b8d82b1c… от выпуска 0.6.2 стоял ещё раньше,
  # 2 995 862 байта.
  sha256 "12b33412ebb139b0462a605b0494ff5d93d9950955f3b526e2457fd13732c75c" # снят локально той же документированной командой, что ниже — сверит CI на теге
