...
class Flang < Formula
  ...
  # пересчитать ещё раз этой же командой. Здесь стоит число, посчитанное на
  # собранном дереве `work/svodka2` 15 августа 2026: на дереве ветки
  # `work/release-sha` та же команда давала
  # b4cf0f10ddd19ea7a59d31060d250cdc36fbb69b1dbd15ef14557378b4f47f34, и разница
  # не в упаковке, а в напечатанном C — вторая волна сборки переписала близнеца
  # и эмиттеры.
  sha256 "49323ba5c2e09e5d39e1fd707ec54b7e2bc59aa5282da294ef3c6caf008082ca"
