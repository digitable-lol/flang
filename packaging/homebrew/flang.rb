...
class Flang < Formula
  ...
  #
  # Число ниже посчитано 3 сентября 2026 на архиве хотфикса 0.7.1: 4 447 763
  # байта, собран вручную тем же рецептом (io-запуск release-in-c.flang был
  # недоступен), проверен полным циклом — распакован с нуля, собран, --version
  # ответил «0.7.1». Прежде здесь стояло ddf21617… от выпуска 0.7.0, чей
  ...
  sha256 "b0d4ce0d5ad1ee91776be6ad8540c72424c25bb4008375229bd7ec47ac98466f"
