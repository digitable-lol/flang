...
class Flang < Formula
  ...
  #
  # Число ниже посчитано 3 сентября 2026 на архиве выпуска 0.7.0: 4 447 759 байт,
  # собран этой же работой выпуска (.github/workflows/publish-npm.yml, шаг
  # «Собрать релизный архив C») и приложен к релизу v0.7.0 тем же файлом.
  # Прежде здесь стояло b8d82b1c… от выпуска 0.6.2, 2 995 862 байта.
  # a1e2e5a9… от выпуска 0.6.1 стоял ещё раньше — тот архив был собран без
  # буквы X и не ставился.
