...
# ярлык «изоляция:подлог» sh --подлог — сторож изоляции краснеет на файле, подложенном выше корня, и зеленеет, когда его убрали — обе стороны прогоном, на игрушечном дереве во временном каталоге
