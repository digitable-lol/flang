...
# ярлык «задачник:номера-подлог» sh --подлог — сторож номеров задач краснеет на двойном номере, на двойнике через каталоги и на отказе без довода, а зеленеет на законном отказе — пять сторон прогоном, во временной копии каталога
