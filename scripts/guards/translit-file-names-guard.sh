...
#   flang/proof/**   ПОКА не судится (ADR-0046 переводит каталог на английские имена
#                    порциями; исключение уходит с последней, задача 6421).
#                    Имя файла — КЛЮЧ записи доказательства (manifest.tsv,
#                    tests/records/corpus/<имя>.record, run.sh): переименование
#                    рвёт ключ. Задачи 1420 и 6421, у них своя цена.
