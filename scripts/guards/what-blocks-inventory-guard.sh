...
#
# ── Как звать ────────────────────────────────────────────────────────────────
#   sh scripts/guards/what-blocks-inventory-guard.sh            сверить, код 1 при расхождении
#   sh scripts/guards/what-blocks-inventory-guard.sh --print    напечатать столбец по дереву
...
exit 0
# ярлык «что-мешает:проверка» sh — столбец «в стволе» таблицы «Где что лежит» сверен с деревом, а не написан руками
