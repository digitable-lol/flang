...
#
#   sh scripts/ledgers/take-proof-ledger.sh flang/stdlib/aes.flang [каталог выходов]
#
...
# (`scripts/ledgers/proved-share-of-a-file.py`). Складывать строки «итог:» нельзя: они
...
#                    собранный `scripts/seed/build-ledger-binary.sh`
