...
# scripts/guards/tree-inventory.fscript, довод «точка раскрутки и приёмка».
#
...
#
#   sh scripts/seed/build-ledger-binary.sh [каталог сборки]
#
...
#
#   KOMMIT=9190b0be sh scripts/seed/build-ledger-binary.sh /путь/куда
set -eu
...
#
# Замерено 30 августа 2026 на scripts/guards/tab-host-guard.fscript. Двоичный ОДИН И ТОТ
...
# (`sh scripts/guards/published-vs-tree.sh --карта`) считает каталоги в корне через
