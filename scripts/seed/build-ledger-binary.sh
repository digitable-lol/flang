...
# scripts/guards/tree-inventory.flang, довод «точка раскрутки и приёмка».
#
...
#
# Замерено 30 августа 2026 на scripts/guards/tab-host-guard.flang. Двоичный ОДИН И ТОТ
