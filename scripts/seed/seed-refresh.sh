...
#
# Как звать:
#   sh scripts/seed/seed-refresh.sh            пересеять
#   sh scripts/seed/seed-refresh.sh --check    только сказать, годен ли быстрый путь
#                                           (для хука перед пушем); дерева не меняет
#   sh scripts/seed/seed-refresh.sh --help
#
