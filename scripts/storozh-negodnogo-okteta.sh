...
#
#   scripts/storozh-negodnogo-okteta.sh              судить все восемь целей
#   scripts/storozh-negodnogo-okteta.sh --цель rust  судить одну
#   scripts/storozh-negodnogo-okteta.sh --порча      проверить самого сторожа
#
# Коды возврата:
...
# (docs/adr/0006-oktety-u-faylov.md). Прогонщики сведены к нему же.
#
...
#
#   PAMYAT=150G flang-vorota -- scripts/storozh-negodnogo-okteta.sh
#
