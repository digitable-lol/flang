...
/*
  ...
  Свидетель здесь — обычная сборка, а не интерпретатор. С интерпретатором обычную
 ...
 * flang_runtime.c), — но мелкий стек всё равно разводит wasm со свидетелем там,
 * где свидетель досчитывает: 7 расхождений из 9139 точек без флага и 0 с
 * `--stack 1048576`.
 *
