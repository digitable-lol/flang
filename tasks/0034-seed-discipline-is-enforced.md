...
```
$ sh scripts/seed-knows-type-words-guard.sh <1004 файла>
сторож слов: файлов 1004, слов в позициях типа 37644, словарь семени 809, чужих семени 0
код возврата: 0
```
...
сторож слов: файлов 1116, слов в позициях типа 39398, словарь семени 809, чужих семени 46
код возврата: 1
```
