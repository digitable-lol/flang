в архив 11 сентября 2026: discriminating-search.mjs снят (d6139b409), двойник .flang берёт mktemp -d в ${TMPDIR}; остаток (сторож времянок в корне, маски .gitignore) шире покрыт задачей 1315
