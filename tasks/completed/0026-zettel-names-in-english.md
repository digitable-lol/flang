...
Стояло «в работе», исполнитель `b`, ветка `b/zettel-english-names`. Ветки на удалённом нет; что из работы дошло до `dev` — ниже, коммитами.

## Чем закрыта

- `058d9f0d` — 191 заметка названа английскими словами вместо русских латиницей, 443 ссылки переписаны в 234 файлах;
- `ca4c790c`, `59105583` — остаток имён и указатель.

Проверено 8 сентября 2026: в `docs/zettel/` 643 файла, имён с кириллицей 0.
